(custom-set-variables
 ...
 '(deft-directory "/home/saunders/projects/the-library/Dropbox/emacs-deft")
 '(deft-extension "md")
 ...
 '(filesets-data (quote (("or-core-scala" (:tree "~/projects/the-livingroom/dvcs-mirrors/bitbucket.com/iesl@bitbucket.com/openreview/prj-openreview-core/src" "^.+\\.scala$")))))
 '(fill-column 100)
...
(setq filesets-data 
      '(
        ("or-core-scala"
         (:tree 
          "~/projects/the-livingroom/dvcs-mirrors/bitbucket.com/iesl@bitbucket.com/openreview/prj-openreview-core/src"
          "^.+\\.scala$"))
        )
)
